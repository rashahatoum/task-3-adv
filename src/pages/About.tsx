        ...
        <div className="container">
          ...
          <OurMission
            ourMissionCards={[
              {
                title: "Mission",
                icon: "/task-3-adv/assets/imgs/mountain.png",
      ...
      <section className="section">
        <div className="container">
          ...
          <Awards
            BenefitsCards={[
              {
                icon: "/task-3-adv/assets/imgs/circle-graphs.png",
              ...
              {
                icon: "/task-3-adv/assets/imgs/thunder.png",
        ...
        <div className="container">
          ...
          <History
            HistoryLines={[
              {
                year: "2023",
                img: "/task-3-adv/assets/imgs/about-squares.png",
      ...
      <section className="section">
        <div className="container">
          ...
          <Members
            MemberCards={[
              {
                img: "/task-3-adv/assets/imgs/MsSarah.png",
              ...
              {
                img: "/task-3-adv/assets/imgs/MrDavid.png",
              ...
              {
                img: "/task-3-adv/assets/imgs/MsEmily.png",
              ...
              {
                img: "/task-3-adv/assets/imgs/MrMichael.png",
              ...
              {
                img: "/task-3-adv/assets/imgs/MsJessica.png",
                name: "Ms. Jessica Lee",
              ...
              {
                img: "/task-3-adv/assets/imgs/MrWilliam.png",
