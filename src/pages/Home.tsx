...
const benefitsCards = [
  {
    icon: `${ASSETS_BASE_PATH}/Graduated.png`,
...
const testimonialsCards = [
  {
    img: `${ASSETS_BASE_PATH}/Jennifer.png`,
    name: "Jennifer B",
    rating: 5,
  ...
  {
    img: `${ASSETS_BASE_PATH}/David.png`,
    name: "David K",
    rating: 5,
  ...
  {
    img: `${ASSETS_BASE_PATH}/Emily.png`,
    name: "Emily L",
    rating: 5,
...
const Home = () => {
  return (
    <>
      <Hero
        heroImg={`${ASSETS_BASE_PATH}/Hero-image.png`}
      ...
      <section className="section">
        <div className="container">
          ...
          />
          <Testimonials TestimonialsCards={testimonialsCards} />
        </div>
      </section>
      <section className="section">
        <div className="container">
          ...
          />
          <Questions questions={frequentlyAskedQuestions} />
        </div>
      </section>
      <section className="section">
        <div className="container">
